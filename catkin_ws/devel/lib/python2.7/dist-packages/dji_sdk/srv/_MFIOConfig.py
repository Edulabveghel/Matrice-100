...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2BIH.pack(_x.mode, _x.channel, _x.init_on_time_us, _x.pwm_freq))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mode, _x.channel, _x.init_on_time_us, _x.pwm_freq,) = _struct_2BIH.unpack(str[start:end])
      return self
