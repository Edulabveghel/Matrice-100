...
if("TRUE" STREQUAL "TRUE")
  set(imu_reader_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/imu_reader)
  set(imu_reader_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(imu_reader_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/src/imu_reader/include " STREQUAL " ")
  set(imu_reader_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/imu_reader/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'imu_reader' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tim Ackermans <tim.ackernas@actemium.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'imu_reader' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/imu_reader/${idir}'.  Ask the maintainer 'Tim Ackermans <tim.ackernas@actemium.com>' to fix it.")
    endif()
